...
import 'package:calculate_time_app/app_utils/constants/app_color.dart';
import 'package:calculate_time_app/app_utils/extension/string_extension.dart';

class Const {
  static NavigationBarColor navigationBarColor = NavigationBarColor();
  static String packageName = 'com.calculate_time_app';
...
class MyDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        width: width ?? MediaQuery.of(context).size.width, height: height, decoration: BoxDecoration(color: dividerColor ?? AppColor.colorGrayBorder));
  }
}
