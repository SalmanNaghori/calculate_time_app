...
import 'package:calculate_time_app/app_utils/navigation_key/global_key.dart';
...
class Dimensions {
  ...
  static double w1half = 0.5.dynamicW;
  ...
  static double w116 = 116.0.dynamicW;
  ...
  static double w156 = 156.0.dynamicW;
  ...
  static double h128 = 128.0.dynamicH;
  static double h130 = 130.0.dynamicH;
  static double h135 = 135.0.dynamicH;
  static double h136 = 136.0.dynamicH;
  static double h137 = 137.0.dynamicH;
  static double h138 = 138.0.dynamicH;
  ...
  static double sp27 = 27.0.dynamicSP;
  static double sp28 = 28.0.dynamicSP;
  static double sp29 = 29.0.dynamicSP;
  static double sp30 = 30.0.dynamicSP;
  static double sp32 = 32.0.dynamicSP;
  static double sp34 = 34.0.dynamicSP;
  ...
  static double getSafeAreaBottomHeight() {
    return MediaQuery.of(GlobalVariable.appContext).padding.bottom;
  }

  static double getBottomButtonHeight() {
    return 52.0 + MediaQuery.of(GlobalVariable.appContext).padding.bottom;
  }

  static double getImagePaddingFromTopHeight() {
    return h20 + MediaQuery.of(GlobalVariable.appContext).padding.top;
  }

  static double getSafeAreaTopHeight() {
    return MediaQuery.of(GlobalVariable.appContext).padding.top;
  }

  static double bottomPadding() {
    return buttonHeight() +
        MediaQuery.of(GlobalVariable.appContext).padding.bottom;
  }

  static double topPaddingWithSafeAreaHeight() {
    return buttonHeight() +
        MediaQuery.of(GlobalVariable.appContext).padding.top;
  }

  static double screenWidth() {
    return MediaQuery.of(GlobalVariable.appContext).size.width;
  }

  static double screenHeight() {
    return MediaQuery.of(GlobalVariable.appContext).size.height;
  }

  static double getKeyBoardHeight() {
    return MediaQuery.of(GlobalVariable.appContext).viewInsets.bottom;
  }
